...
test("brands the full video bottom-left and preserves audio", { skip: process.platform !== "darwin" && "macOS text-safe frame review runs on the Mac worker" }, async () => {
  ...
  try {
    ...
    assert.equal(result.bottomMargin, 203);
